...
INSERT INTO tb_user (id, email, password, create_date, update_date, blocked) VALUES (random_uuid(), 'admin@email.com', 'admin', NOW(), NULL, false);
INSERT INTO tb_user (id, email, password, create_date, update_date, blocked) VALUES (random_uuid(), 'user1@email.com', 'user1', NOW(), NULL, false);
INSERT INTO tb_user (id, email, password, create_date, update_date, blocked) VALUES (random_uuid(), 'user2@email.com', 'user2', NOW(), NULL, false);
INSERT INTO tb_user (id, email, password, create_date, update_date, blocked) VALUES (random_uuid(), 'user3@email.com', 'user3', NOW(), NULL, false);